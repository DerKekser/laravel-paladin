...
*This PR was automatically generated by [Laravel Paladin](https://github.com/DerKekser/laravel-paladin)*',
    ...
    | To use multiple providers, separate them with a comma (e.g., 'github,mail').
    |
    */
    ...
    |
    | When using the "laravel-ai" evaluator, configure the provider and
    | model below:
    |
