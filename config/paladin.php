...
*This PR was automatically generated by [Laravel Paladin](https://github.com/DerKekser/laravel-paladin)*',
    ...
    */
    ...
    | - "simple": A non-AI evaluator that analyzes logs using pattern matching
    | and heuristics. Requires no external services or credentials.
    | Generates generic fix prompts based on extracted error data.
    |
